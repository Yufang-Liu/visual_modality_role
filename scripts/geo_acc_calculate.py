...
if __name__ == "__main__":
    ...
    parser.add_argument("--ground_truth_file", type=str, default="test_answers.jsonl")
    parser.add_argument("--predictions_file", type=str, default="llava1.5_7b_geo_finetuned_test.jsonl")
    parser.add_argument("--question_file", type=str, default="test_questions.jsonl")
